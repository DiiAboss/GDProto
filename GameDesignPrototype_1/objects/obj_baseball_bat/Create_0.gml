...
sweet_spot_distance = 32; // Distance from owner where sweet spot exists
sweet_spot_radius = 32;    // How big the sweet spot is
sweet_spot_active_start = 0.4; // Swing progress when sweet spot activates
sweet_spot_active_end = 0.6;   // Swing progress when sweet spot deactivates
